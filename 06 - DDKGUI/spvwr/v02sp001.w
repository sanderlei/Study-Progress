...
Customer.Phone Customer.City Customer.State Customer.Postal-Code ~
Customer.Country 
...
DEFINE FRAME f-main
     Customer.Address AT ROW 1.5 COL 39 COLON-ALIGNED WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 21.14 BY .88
     Customer.Address2 AT ROW 2.5 COL 39 COLON-ALIGNED WIDGET-ID 4
          VIEW-AS FILL-IN 
          SIZE 21.14 BY .88
     Customer.Phone AT ROW 3.5 COL 39 COLON-ALIGNED WIDGET-ID 10
          VIEW-AS FILL-IN 
          SIZE 21.14 BY .88
     Customer.City AT ROW 4.5 COL 39 COLON-ALIGNED WIDGET-ID 6
          VIEW-AS FILL-IN 
          SIZE 16.14 BY .88
     Customer.State AT ROW 5.5 COL 39 COLON-ALIGNED WIDGET-ID 14
          VIEW-AS FILL-IN 
          SIZE 21.14 BY .88
     Customer.Postal-Code AT ROW 6.5 COL 39 COLON-ALIGNED WIDGET-ID 12
          VIEW-AS FILL-IN 
          SIZE 14.14 BY .88
     Customer.Country AT ROW 7.5 COL 39 COLON-ALIGNED WIDGET-ID 8
          VIEW-AS FILL-IN 
          SIZE 21.14 BY .88
